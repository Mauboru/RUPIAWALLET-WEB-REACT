  ...
  export default function EditarTransacao({ transaction, onCancel, onUpdated }) {
    ...
    return (
      <MainLayout>
        ...
        <Styled.Form onSubmit={handleSubmit}>
          ...
          {onCancel && (
            <Styled.Button type="button" onClick={onCancel} disabled={loading} style={{ backgroundColor: '#999', marginTop: '8px' }}>
              Cancelar
            </Styled.Button>
          )}
        </Styled.Form>
